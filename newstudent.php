		              ...
		              <div class="col-md-6">
		                ...
		                <div class="col-md-8">
							  ...
							  <div class="checkbox">
							   ...
							   <div class="checkbox">
							    <label>
							      <input type="checkbox" name="mir_contract" value="yes"/> HSC Certificate
							    </label>
							    
							  </div>
							  <div class="checkbox">
							    <label>
							      <input type="checkbox" name="baptismal" value="yes"/> HSC Mark Sheet
							    </label>
							    
							  </div>
							  <div class="checkbox">
							    <label>
							      <input type="checkbox" name="nso" value="yes"/> SSC Certificate
							    </label>
							    
							  </div>
							  <div class="checkbox">
							    <label>
							      <input type="checkbox" name="nso" value="yes"/> SSC Mark Sheet
							    </label>
							    
							  </div>
							   <div class="checkbox">
							    <label>
							      <input type="checkbox" name="certifcateOfTransfer" value="yes"/> Testimonial
							    </label>
