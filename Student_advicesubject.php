					  ...
					  <div class="panel-body">
					   ...
					   <div class="row">
				           ...
				           <table align="center">
						     ...
						     <tbody>
						     	<tr>
						     		<td><?php echo (isset($cur)) ? $cur->IDNO : '' ;?></td>
						     		<td><?php echo (isset($cur)) ? $cur->LNAME.', '.$cur->FNAME : '' ;?></td>
						     		<td><?php echo (isset($sy)) ? $sy->STATUS : '' ;?></td>
						     		<td><?php echo (isset($sy)) ? $sy->AY : '' ;?></td>
						     		<td><?php echo (isset($sy)) ? $sy->SEMESTER : '' ;?></td>
						     		<td><?php echo (isset($studcourse)) ? $studcourse->COURSE_NAME .' - '.$studcourse->COURSE_LEVEL.$studcourse->COURSE_MAJOR : '' ;?></td>
						     	</tr>
						      </tbody>
						       <tfoot>
            ...
            <div class="col-10 col-sm-10 col-lg-10">
				  ...
				  <thead>
				  	<tr id="table">
				 		...
				 		<th width="10%" class="bottom">Course Teacher</th>
				 		<th width="10%" class="bottom">Credit</th>
				 		<th width="10%" class="bottom">Pre-requisite</th>
				 		<th width="10%" align="center" class="bottom"></th>
				  ...
				  <tfoot>
					...
					<tr><td  colspan="7"></td></tr>
				  	<tr><td colspan="2">Date Printed:  <? print(Date("l F d, Y")); ?> .</td><td colspan="2">Advised and signed by:</td><td ></td></tr>
						...
						<div class="btn-group">
						  <a href="?txtsearch=<?php echo $_POST['txtsearch']; ?>" class="btn btn-default"><span class="glyphicon glyphicon-plus-sign"></span> Preview</a>
